...
export function Footer() {
  ...
  const footerLinks = {
    [t.footer.company]: [t.footer.about, t.footer.services, t.footer.contact, t.footer.blog],
    [t.footer.treatments]: [t.footer.t1, t.footer.t2, t.footer.t3, t.footer.t4],
    [t.footer.legal]: [t.footer.privacy, t.footer.terms, t.footer.cookie],
  };
            ...
            <div key={group}>
              ...
              <ul className="flex flex-col gap-2.5">
                {links.map((link, idx) => (
                  <li key={idx}>
                    <Link
                      href={link === t.footer.contact ? `/${locale}/contact` : `/${locale}`}
